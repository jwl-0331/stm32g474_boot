...
#define FLASH_DESC_STR      "@Internal Flash   /0x08000000/64*01Ka,64*01Ka"
...
{
  /* USER CODE BEGIN 2 */
  // ADD 로오는 하나의 Sector를 지운다, length sector 1개 1024
