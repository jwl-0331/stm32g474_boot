...
#define CLI_CMD_LIST_MAX      HW_CLI_CMD_LIST_MAX  //16
#define CLI_CMD_NAME_MAX      HW_CLI_CMD_NAME_MAX  //16

#define CLI_LINE_HIS_MAX      HW_CLI_LINE_HIS_MAX // 4
#define CLI_LINE_BUF_MAX      HW_CLI_LINE_BUF_MAX //64
...
#endif /* SRC_COMMON_INCLUDE_CLI_H_ */
